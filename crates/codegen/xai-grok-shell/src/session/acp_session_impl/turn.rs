    ...
    pub(super) async fn handle_prompt(
        ...
        *self.turn_prompt_mode.lock() = prompt_mode;
        ...
        let loop_fire_mode = if self.rebuild_spec.scheduler_background_loops {
            xai_grok_tools::implementations::grok_build::scheduler::create::LoopFireMode::Detached
        } else {
            xai_grok_tools::implementations::grok_build::scheduler::create::LoopFireMode::InSession
        };

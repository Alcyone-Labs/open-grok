...
/// Start (if needed) and submit the initial prompt from `open-grok "<prompt>"`.
///
...
/// Show the one-shot "Over SSH? Run `open-grok wrap ssh <host>` locally…" hint at

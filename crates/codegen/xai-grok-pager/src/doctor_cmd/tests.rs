...
fn mixed_report() -> DiagnosticReport {
    ...
    report.findings = vec![
        ...
        DiagnosticFinding {
            ...
            message: "Use local SSH wrapping".to_owned(),
            remediation: Some(ManualRemediation {
                fix: "open-grok wrap ssh <host>".to_owned(),
                config_path: None,
            }),
            automatic_remediation: Some(crate::diagnostics::ssh_wrap_automatic_remediation()),
            note: None,
...
fn fix_preview_contains_exact_change_and_caveats() {
    ...
    assert!(preview.contains("To use once without changing config: `open-grok wrap ssh <host>`"));
        ...
        serde_json::json!({
            ...
            "findings": [
                ...
                },
                {
                    ...
                    "remediation": {"fix": "open-grok wrap ssh <host>", "configPath": null},
                    "automaticRemediation": {

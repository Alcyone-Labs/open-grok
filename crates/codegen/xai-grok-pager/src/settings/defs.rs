...
const SCREEN_MODE_CHOICES: &[EnumChoice] = &[
    EnumChoice {
        ...
        display: "Fullscreen",
        description: "Launch Open Grok in the standard fullscreen TUI. Default when unset.",
    },
    EnumChoice {
        canonical: "minimal",
        display: "Minimal",
        description: "Launch Open Grok in scrollback-native (minimal) mode.",
    },
];
...
pub fn default_settings() -> Vec<SettingMeta> {
    ...
    vec![
        ...
        SettingMeta {
            ...
            description: "How Open Grok opens next time: Fullscreen (default when unset) or \
        ...
        SettingMeta {
            ...
            keywords: &["opencode", "go", "api", "key", "credential", "models"],
            kind: SettingKind::Secret,
            restart_required: false,
            hidden_in_minimal: false,
        },
        SettingMeta {
            ...
            keywords: &["opencode", "go", "models", "enable", "disable", "subagents"],
        ...
        SettingMeta {
            ...
            keywords: &["web", "search", "source", "fireworks", "xai", "perplexity"],
            kind: SettingKind::Enum {
                default: "xai",
                choices: WEB_SEARCH_SOURCE_XAI_DEFAULT_CHOICES,
                supports_preview: false,
        ...
        SettingMeta {
            ...
            keywords: &["web", "search", "source", "deepseek", "xai", "perplexity"],
            kind: SettingKind::Enum {
                default: "xai",
                choices: WEB_SEARCH_SOURCE_XAI_DEFAULT_CHOICES,
                supports_preview: false,
        ...
        SettingMeta {
            ...
            owner: SettingOwner::Shell,
            label: "SSH wrap",
            description: "At session load over SSH, recommend `open-grok wrap ssh` for \
